...
import {
  createBrand,
  updateBrand,
} from "../../../Components/db/Redux/api/BrandSlice";
import {
  createBanner,
  updateBanner,
} from "../../../Components/db/Redux/api/BannerSlice";
import {
  createPartner,
  updatePartner,
} from "../../../Components/db/Redux/api/PartnerSlice";
...
const Forms = ({ handleClose, data }) => {
  ...
  const [selectedCategory, setSelectedCategory] = useState(
    data ? data.parentSubCategory : null
  );
  const { mode } = useThemeContext();
  const categories = useSelector((state) => state.subcategory.data);
  ...
  useEffect(() => {
    if (data) {
      ...
      setSelectedCategory(data.parentSubCategory || null);
  ...
  const handleSubmit = (e) => {
    ...
    // body.append("subCategoryId", selectedCategory.id);
    ...
    if (formData.nameTm || formData.nameRu || formData.nameEn) {
      data ? dispatch(updatePartner(body)) : dispatch(createPartner(body));
      handleClose();
      setPreview(null);
      setFormData({
        nameTm: "",
